...
- `dev-rfor-scope.md` — rfor v1 scope, syntax, flags, branching plan.
- `dev-rfor-bash-syntax-scope.md` — Bash for-loop syntax feature: `rfor VAR in ITEMS -- COMMAND`, real named vars (user-approved 2026-05-29).
- `dev-rfor-roadmap.md` — Prioritized feature roadmap: 9 features across 4 sprints. Sprint 1: --dry-run + filename tokens. Sprint 2: --group + --retries. Sprint 3: --results + brace expansion. Sprint 4: do/done + multi-bar + multi-vars.
